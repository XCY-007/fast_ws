...
struct Observations
{
    ...
    torch::Tensor foot_contact;
    torch::Tensor imu_rpy;
};
...
public:
    ...
    torch::Tensor quatToRPY(torch::Tensor q);
    ...
    torch::jit::script::Module extra_model;
    torch::jit::script::Module camera_model;
    torch::jit::script::Module op_estimator;
    torch::jit::script::Module selector;
    // output buffer
